...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            StartingWeapons = ContainerWeapons.instance.weapons.Where(w=>w.id == WeaponService.FirstId && w.weaponType == WeaponController.WeaponType.first
            || w.id == WeaponService.SecondId && w.weaponType == WeaponController.WeaponType.second).ToList();   
