...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        public Vector3 GetMoveInput()
        {
            if (CanProcessInput())
            {
                if (Unity.FPS.UI.WeaponHUDManager.instance.isMobile)
                {
                   var joystick = Unity.FPS.UI.WeaponHUDManager.instance.moveJoystick;
        ...
        public float GetLookInputsHorizontal()
        {
            if (Unity.FPS.UI.WeaponHUDManager.instance.isMobile)
            {
                return Unity.FPS.UI.WeaponHUDManager.instance.rotationJoystick.Horizontal;
            }
        ...
        public float GetLookInputsVertical()
        {
            if (Unity.FPS.UI.WeaponHUDManager.instance.isMobile)
            {
                return -(Unity.FPS.UI.WeaponHUDManager.instance.rotationJoystick.Vertical);
            }
        ...
        public bool GetJumpInputDown()
        {
            if (CanProcessInput())
            {
                ...
                if (Unity.FPS.UI.WeaponHUDManager.instance.isMobile)
                {
                    jump = Unity.FPS.UI.WeaponHUDManager.instance.jumpButton.Pressed;
                    return jump;
                }
        ...
        public bool GetFireInputHeld()
        {
            if (CanProcessInput())
            {
                ...
                else
                {
                    ...
                    if (Unity.FPS.UI.WeaponHUDManager.instance.isMobile)
                    {
                        fire = Unity.FPS.UI.WeaponHUDManager.instance.shotButton.Pressed;
                    }
                    else
                    {
                        fire = Input.GetButton(GameConstants.k_ButtonNameFire);
                    }
