...
namespace Unity.FPS.AI
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        public int m_PathDestinationNodeIndex;
        public EnemyMobile enemyMobile;
        public void Start()
        {
        ...
        public void Init()
        {
            ...
            m_ActorsManager = ActorsManager.instance;
            ...
            m_GameFlowManager = GameFlowManager.instance; ;
        ...
        public void SetPathDestinationToClosestNode()
        {
            if (IsPathValid())
            {
                ...
                //if (m_PathDestinationNodeIndex <= PatrolPath.PathNodes.Count-1)
                //{
        ...
        public Vector3 GetDestinationOnPath()
        {
            if (IsPathValid())
            {
                ...
                // Debug.Log($" Index  до = {m_PathDestinationNodeIndex}");
                ...
                //     m_PathDestinationNodeIndex = 0;
                // }
                //Debug.Log($" Index  после = {m_PathDestinationNodeIndex}");
        ...
        public void UpdatePathDestination(bool inverseOrder = false)
        {
            if (IsPathValid())
            {
                ...
                if ((transform.position - GetDestinationOnPath()).magnitude <= PathReachingRadius)
                {
                    ...
                    //    Debug.Log(m_PathDestinationNodeIndex.ToString() + " прибавили");
                    //}

                    //if (m_PathDestinationNodeIndex >= PatrolPath.PathNodes.Count)
                    //{
                    //    m_PathDestinationNodeIndex -= PatrolPath.PathNodes.Count;
                    //    Debug.Log(m_PathDestinationNodeIndex.ToString() + " убавили");
                    //}
                    var rnd = UnityEngine.Random.Range(0, PatrolPath.PathNodes.Count);
                    if(rnd == m_PathDestinationNodeIndex) 
                    {
                        for (int i = 0; i < 1000; i++)
                        {
                            rnd = UnityEngine.Random.Range(0, PatrolPath.PathNodes.Count);
                            if(rnd != m_PathDestinationNodeIndex)
                            {
                                break;
                            }
                    ...
                    Debug.Log(m_PathDestinationNodeIndex);
                    m_PathDestinationNodeIndex = rnd;
                }
