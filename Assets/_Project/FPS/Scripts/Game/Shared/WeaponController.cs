...
namespace Unity.FPS.Game
{
    ...
    {
        public int id;
         public enum WeaponType { first,second }
        ...
        void HandleShoot()
        {
            int bulletsPerShotFinal = ShootType == WeaponShootType.Charge
                ...
                : BulletsPerShot;
          //  Debug.Log(m_CurrentAmmo + "/" + m_CarriedPhysicalBullets + "/" + bulletsPerShotFinal);
            ...
            //Debug.Log(m_CurrentAmmo + "/" + m_CarriedPhysicalBullets + "/" + bulletsPerShotFinal);
            if(m_CurrentAmmo <=  1 && WeaponAnimator != null)
            {
                WeaponAnimator.SetTrigger("Reload");
            }
        }
